...
var hsp = {
  ...
  applyTheme: function (params) {
    ...
    var maxTries = 10;
    var counter = 0;
    var fnOnThemeLoad = params.onThemeLoad
      ? params.onThemeLoad
      : function () {};
...
/**
 * Creates a message in the legacy composer. If your post contains an image or file, use [hsp.attachFileToMessage]{@link #attachFileToMessage} in conjunction.
 * @global
...
/**
 * Creates a message in the new composer.
 * @global
 * @param {string} message - The message text.
 * @param {Object} params - The message parameters.
 * @param {int} [params.scheduleTimestamp] - An optional param to schedule the message. The schedule time can be passed as Unix time. If null is passed in, then the composer will open with no default time.
 * @example
 ...
 */
hsp.composeMessageV2 = function (message, params) {
  hsp.trigger("send_to_compose", {
    text: message,
    params: params,
  });
};
...
/**
 * Attach a file to the new composer. Only images can be attached to a message. Images will be added as attachments.
 * @global
 * @param {Object} data - Input parameters.
 * @param {string} data.url - The URL of the file to attach. Must be HTTPS.
 * @param {string} [data.name] -  The name of the file.
 * @param {string} data.extension - The file extension. Valid image extensions: jpg, jpeg, gif, png.
 * @param {int} data.timestamp - The current Unix time, used for authentication.
 * @param {string} data.token - SHA512(user_id + timestamp + url + secret)
 * @example
hsp.attachFileToMessageV2({
    url: "https://hootsuite.com/var/hootsuite/storage/images/media/images/media-kit/office-photos/hq2/53153-2-eng-US/hq2.jpg",
    name: "hq2.jpg",
    extension: "jpg",
    timestamp: 1472580556,
 ...
 */
hsp.attachFileToMessageV2 = function (data) {
  hsp.trigger("attach_file_to_compose", {
    file: data,
  });
};
/**
 ...
 */
hsp.attachMediaV2 = function (data) {
  hsp.trigger("attach_media_to_compose", {
    media: data,
  });
};
/**
 * Open a reply modal to reply to a tweet.
 * @global
 * @param {string} twitterReplyToId - The Twitter Post ID of the Twitter message being replied to. See example below.
 * @example
 hsp.reply({
    twitterReplyToId: '627186559909900288'
 });
 */
hsp.reply = function (twitterReplyToId) {
  hsp.trigger("reply", {
    data: {
      twitterReplyToId: twitterReplyToId,
    },
  });
};
/**
